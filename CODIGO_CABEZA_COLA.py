...
print ('*INICIA PROCESO DE CÁLCULO DE CABEZA COLA...*')
varios_destinatarios('*INICIA PROCESO DE CÁLCULO DE CABEZA COLA...*')
pdvs=pd.DataFrame()
pdvs['BODEGA']=['173','254','161','212']
...
print('Paso 1 de 6: Leyendo Archivo de Clasificación')
varios_destinatarios('*Paso 1 de 6:*\nLeyendo Archivo de Clasificación')
cnxn7 = connect('192.168.238.7',  port=21050, auth_mechanism='NOSASL', database='dwh')
cursor7 = cnxn7.cursor(user = 'ccalan')
cursor7.execute('select user();')
...
except FileNotFoundError: print("El archivo no existe / No está en la ubicación correcta. ",list_catalogo), varios_destinatarios('*El archivo no existe / No está en la ubicación correcta. '+str(list_catalogo))
except PermissionError: print("No tienes permiso para leer este archivo. ",list_catalogo), varios_destinatarios('*No tienes permiso para leer este archivo. '+str(list_catalogo))
...
#%%
print ('Paso 2 de 6: Lectura y limpieza de archivo de clasificación')
varios_destinatarios('*Paso 2 de 6:*\nLectura y limpieza de archivo de clasificación')
...
print ('Paso 3 de 6: Análisis de Regla de Scott')
varios_destinatarios('*Paso 3 de 6:*\nAnálisis de Regla de Scott')
for PDV in tqdm(List_PDV):
    ...
    del data,NumGrupos,ReglaScott,NumSKU,Desvest,Brecha,PDVCatAux,CabCol, etiquetas
        ...
        if i=='SuperCabezaCola':
            ...
            for j in data['CATEGORIA'].unique():
                if j=='E':
                    ...
                    ancho_grupo=round(ancho_grupo['ReglaScott'].iloc[0])
...
print('Paso 4 de 6: Análisis de Regla de Scott ejecutado correctamente')    
varios_destinatarios('*Paso 4 de 6:*\nAnálisis de Regla de Scott ejecutado correctamente')
...
print('Paso 5 de 6: Generando CSV')
varios_destinatarios('*Paso 5 de 6:*\nGenerando CSV')
consolidado.to_csv('NUEVOS_MAXIMOS.csv',index=False)
print ('Paso 6 de 6: CSV generado correctamente')
varios_destinatarios('*Paso 6 de 6:*\nCSV generado correctamente')
